...
export const useBarcodePrintArrayBarcodePrintArrayPostMutation = (
  options?: Omit<
    UseMutationOptions<
      AxiosResponse<any>,
      unknown,
  ...
  return useMutation({
    ...
    mutationFn: (params: DefaultApiBarcodePrintArrayPostRequest) =>
      barcodePrintArrayMutate
        .barcodePrintArrayPost(params)
